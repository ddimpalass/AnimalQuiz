...
class QuestionsViewController: UIViewController {
    ...
    private var animalChosen: [AnimalType] = []
    ...
    @IBAction func singleButtonAnswerPressed(_ sender: UIButton) {
        ...
        animalChosen.append(currentAnswer.type)
    ...
    @IBAction func rangedAnsweButtonPressed() {
        let index = Int(String(format: "%.0f", rangedSlider.value))
        answerChosen.append(currentAnswers[index ?? 0])
        animalChosen.append(currentAnswers[index ?? 0].type)
...
extension QuestionsViewController {
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        resultViewController.animalChosen = animalChosen
    }
}
